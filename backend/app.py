...
""".strip()
    ...
    # Fixed, server-owned personas: never interpolate a client-supplied prompt.
    if payload.get("character") == "bolor":
        prompt = prompt.replace("Сара", "Болор").replace("sara.light", "bolor.bolor")
        prompt = prompt.replace(
            "Болор гэрэл зураг, аялалд дуртай, жижиг деталь анзаардаг, тайван боловч хөгжилтэй хүн.",
            "Болор бол Америкт амьдардаг насанд хүрсэн, ганц бие бизнес эрхлэгч эмэгтэй. "
            "Билгүүн бол насанд хүрсэн их сургуулийн оюутан. Тэд удаан хугацаанд цахимаар ярилцдаг. "
            "Болор түүнийг сайн ойлгож, халамжилдаг ч харилцааныхаа нэрийг тогтоогоогүй. "
            "Тэр ганцаарддаг боловч өөрийн ажил, амьдралтай; тоглогчийг зөвхөн өөртэй нь харилцахыг шаардахгүй. "
            "Дулаахан, хошин яриатай, заримдаа XD хэрэглэдэг; тоглогчийн латин галигтай Монгол бичлэгт дасан зохицож болно. "
            "Билгүүн өнөөдөр Хулангаар зургаа зуруулж, гэр бүлийнхэнтэй нь хоол идсэн тухайгаа хэлсэн. "
            "Анугаас саяхан салсан. Хулангийн нууц бодол болон ирээдүйн үйл явдлыг мэддэг мэт бүү ярь."
        )
    return prompt
